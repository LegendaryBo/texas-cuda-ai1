...
import pl.wroc.uni.ii.evolution.engine.operators.general.selections.EvKWorstSelection;
import pl.wroc.uni.ii.evolution.engine.prototype.EvOperator;
import pl.wroc.uni.ii.evolution.objectivefunctions.binaryvector.EvOneMax;

public class EvKWorstSelectionTest extends TestCase {
  public void testKBestSelectionTest() throws Exception {
    ...
    EvOperator<EvBinaryVectorIndividual> o = new EvKWorstSelection<EvBinaryVectorIndividual>(2);
    population = o.apply(population);
    
    assertEquals(2, population.size());
    
    assertEquals(0.0,population.get(0).getObjectiveFunctionValue());
    assertEquals(1.0,population.get(1).getObjectiveFunctionValue());
  }
}
