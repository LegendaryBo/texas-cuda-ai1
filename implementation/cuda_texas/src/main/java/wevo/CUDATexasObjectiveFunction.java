...
public class CUDATexasObjectiveFunction implements EvObjectiveFunction<EvBinaryVectorIndividual> {
	...
	/**
	 * 
	 * @param liczbaGeneracji (ile generacji ma grac z osobnikiem, dac na 11)
	 * @param liczbaWatkowNaBlok - liczba watkow uzytych do rozegrania jednej partii
	 * @param liczbaPartii - liczba partii
	 */
	...
	public double evaluate(EvBinaryVectorIndividual obliczany_osobnik) {
		...
		ai_texas_swig.rozegrajNGierCUDA(LICZBA_OSOBNIKOW, osobniki_ptr , wynik_cuda, 
				liczbaPartii, LICZBA_INTOW, liczbaWatkowNaBlok);
