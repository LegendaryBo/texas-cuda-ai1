...
public class EvStatystykiKartWygranegoChart {
  ...
  public static JFreeChart createJFreeChart(final EvStatistic[] stats) {
    final JFreeChart chart =
        ChartFactory.createXYLineChart("Srednia wygrana/przegrana (srednia populacji)", "Iteration",
  ...
  public static XYDataset getDataSet(final EvStatistic[] stats) {
    ...
    if (stats != null) {
      ...
      for (EvStatistic stat : stats) {
        float[] genes_value = ((EvStatystykiKartWygranegoStatistic) stat).statystykiKart;
