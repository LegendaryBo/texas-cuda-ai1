...
/**
 * Benchmark for block selection operator.
 * @author Kacper Gorski
 */
public final class EvBlockSelectionBenchmark {
  ...
  public static void main(final String[] args) {
    ...
    alg.addOperatorToEnd(new EvBlockSelection<EvBinaryVectorIndividual>(10));
    
    alg.setTerminationCondition(
        new EvMaxIteration<EvBinaryVectorIndividual>(1000));
   ...
   */
  private EvBlockSelectionBenchmark() { }
}
